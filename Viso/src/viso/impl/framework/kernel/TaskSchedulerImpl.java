...
final class TaskSchedulerImpl implements TaskScheduler {
	 ...
	 * threads.
	 */
	public static final String CONSUMER_THREADS_PROPERTY = "viso.impl.kernel.task.threads";
	...
	public TaskReservation reserveTask(KernelRunnable task, Identity owner) {
		TaskDetail detail = new TaskDetail(task, owner, System
				.currentTimeMillis());
	...
	public void scheduleTask(KernelRunnable task, Identity owner, long startTime) {
		try {
			...
			executor.schedule(new TaskRunner(detail), startTime
