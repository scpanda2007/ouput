...
public class PropertiesWrapper {
	...
	public int getIntProperty(String arg0, int arg1, int min, int max) {
		...
		if (value >= min && value <= max)
			return value;
		throw new IllegalArgumentException(" the param " + arg0
				+ " with value:" + value + " is not between " + min + " and "
				+ max);
	}

	public long getLongProperty(String arg0, long default_, long min, long max) {
	...
	public <T> T getClassInstanceProperty(String arg0, Class<T> class1,
			Class<?>[] classes, Object... arg2) {
		// TODO Auto-generated method stub
		return getClassInstanceProperty(arg0, null, class1, classes, arg2);
	}

	public <T> T getClassInstanceProperty(String arg0, String default_,
			Class<T> class1, Class<?>[] classes, Object... arg2) {
		// TODO Auto-generated method stub
		Object obj;
		try {
			if (default_ != null)
				obj = Class.forName(properties.getProperty(arg0, default_))
						.getConstructor(classes).newInstance(arg2);
			else
				obj = Class.forName(properties.getProperty(arg0))
						.getConstructor(classes).newInstance(arg2);
			...
			if (e instanceof InvocationTargetException) {
				if (((InvocationTargetException) e).getTargetException() instanceof RuntimeException) {
					throw ((RuntimeException) ((InvocationTargetException) e)
							.getTargetException());
				}
			}
	...
	public boolean getBooleanProperty(String arg0, boolean defaultBoolean) {
		// TODO Auto-generated method stub
		return Boolean.parseBoolean(properties.getProperty(arg0, (new Boolean(
				defaultBoolean)).toString()));
	}

	public <T extends Enum<T>> T getEnumProperty(String property,
			Class<T> class1, T defaultValue) {
		// TODO Auto-generated method stub
		return Enum.valueOf(class1, properties.getProperty(property,
