...
public abstract class AbstractAccessCoordinator implements
	 ...
	 */
	public abstract class AbstractAccessReporter<T> implements
			AccessReporter<T> {
		...
		public void setObjectDescription(T objId, Object description) {
			setObjectDescription(txnProxy.getCurrentTransaction(), objId,
					description);
		}
	}
}