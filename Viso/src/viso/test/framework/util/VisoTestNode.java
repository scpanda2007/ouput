...
//            "viso.framework.impl.service.data.store.DataStoreImpl.directory",
//                dir + ".db",
//            "viso.framework.impl.service.data.store.net.server.port", 
//                String.valueOf(requestedDataPort),
// "viso.framework.impl.service.data.DataServiceImpl.data.store.class",
// "viso.framework.impl.service.data.store.net.DataStoreClient",
// "viso.framework.impl.service.watchdog.server.port",
// String.valueOf(requestedWatchdogPort),
// "viso.framework.impl.service.channel.server.port",
// String.valueOf(getNextUniquePort()),
// "viso.framework.impl.service.session.server.port",
// String.valueOf(getNextUniquePort()),
// "viso.framework.impl.service.nodemap.client.port",
// String.valueOf(getNextUniquePort()),
// "viso.framework.impl.service.watchdog.client.port",
// String.valueOf(getNextUniquePort()),
// "viso.framework.impl.service.watchdog.server.renew.interval", "1500",
// "viso.framework.impl.service.nodemap.server.port",
// String.valueOf(requestedNodeMapPort),
// LPADriver.GRAPH_CLASS_PROPERTY, "None",
// "viso.framework.impl.service.nodemap.remove.expire.time", "1000",
// "viso.framework.impl.service.task.continue.threshold", "10"
        );
