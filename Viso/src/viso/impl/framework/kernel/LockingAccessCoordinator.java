...
import viso.framework.service.TransactionInterruptedException;
...
import viso.impl.util.lock.LockConflict;
import viso.impl.util.lock.LockConflictType;
import viso.impl.util.lock.LockManager;
import viso.impl.util.lock.LockRequest;
...
public class LockingAccessCoordinator extends AbstractAccessCoordinator {
	...
	static final LoggerWrapper logger = new LoggerWrapper(Logger
			.getLogger(LockingAccessCoordinator.class.getName()));
