...
import viso.framework.service.NonDurableTransactionParticipant;
...
public abstract class TransactionContextFactory<T extends TransactionContext> {
	...
	private static final LoggerWrapper logger = new LoggerWrapper(Logger
			.getLogger(TransactionContextFactory.class.getName()));
	...
	protected class Participant implements TransactionParticipant {
		...
		public void prepareAndCommit(Transaction txn) throws Exception {
			try {
				...
				contextMap.clearContext();
				logger
						.log(Level.FINER, "prepareAndCommit txn:{0} returns",
								txn);
