...
import viso.impl.framework.service.data.store.AbstractDataStore;
import viso.impl.framework.service.data.store.BindingValue;
import viso.impl.framework.service.data.store.NetworkException;
...
public final class DataStoreClient extends AbstractDataStore {
	...
	private static final String PACKAGE = "viso.impl.framework.service.data.store.net";
