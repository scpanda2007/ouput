...
import viso.framework.profile.TaskProfileCounter;
import viso.framework.profile.TaskProfileOperation;
import viso.framework.profile.TaskProfileSample;
...
class ProfileConsumerImpl implements ProfileConsumer {
	...
	PropertyChangeEvent event = 
	    new PropertyChangeEvent(this, 
                                    "viso.framework.profile.newop", null, op);
